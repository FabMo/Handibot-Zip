...
$("#pref-save").click(function(evt) {
  ...
  var new_materthick = "$Material_Thickness =" + validateInput($("#pref-input-materthick"));
...
$("#pref-cancel").click(function(evt) {
  fabmo.getConfig(function(err, cfg) {
	...
	if (cfg.opensbp.variables.Material_Thickness) {
      $('#pref-input-materthick').val(cfg.opensbp.variables.Material_Thickness);
    }  
  });
...
$("#setup-tab-link").click(function(evt) {
  fabmo.getConfig(function(err, cfg) {
    if (cfg.opensbp.variables.current_cutter_Zoffset) 
      {$('#pref-input-cur-zlength').val(cfg.opensbp.variables.current_cutter_Zoffset);
    }
